...
class WeeklyBalance(Base):
    __tablename__ = "WeeklyBalance"
    ...
    origin = relationship("Origin", foreign_keys=[originId], back_populates="weeklyBalances")  # Relación con "Origin"
    frequency = relationship("Frequency",foreign_keys=[frequencyId],  back_populates="weeklyBalances")
