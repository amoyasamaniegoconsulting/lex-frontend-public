...
class SemiannualBalance(Base):
    __tablename__ = "SemiannualBalance"
    ...
    origin = relationship("Origin", foreign_keys=[originId], back_populates="semiannualBalances")  # Relación con "Origin"
    frequency = relationship("Frequency",foreign_keys=[frequencyId],  back_populates="semiannualBalances")
