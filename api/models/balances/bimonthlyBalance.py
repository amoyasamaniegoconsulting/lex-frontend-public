...
class BimonthlyBalance(Base):
    __tablename__ = "BimonthlyBalance"
    ...
    origin = relationship("Origin", foreign_keys=[originId], back_populates="bimonthlyBalances")  # Relación con "Origin"
    frequency = relationship("Frequency",foreign_keys=[frequencyId],  back_populates="bimonthlyBalances")
