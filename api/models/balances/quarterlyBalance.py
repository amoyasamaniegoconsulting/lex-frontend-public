...
class QuarterlyBalance(Base):
    __tablename__ = "QuarterlyBalance"
    ...
    origin = relationship("Origin", foreign_keys=[originId], back_populates="quarterlyBalances")  # Relación con "Origin"
    frequency = relationship("Frequency",foreign_keys=[frequencyId],  back_populates="quarterlyBalances")
