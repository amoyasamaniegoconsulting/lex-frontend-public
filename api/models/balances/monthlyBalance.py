...
class MonthlyBalance(Base):
    ...
    origin = relationship("Origin", foreign_keys=[originId], back_populates="monthlyBalances")  # Relación con "Origin"
    frequency = relationship("Frequency",foreign_keys=[frequencyId],  back_populates="monthlyBalances")
